...
export class AccountClient {
    ...
    switchCompany(id: number): Observable<SwaggerResponse<UsuarioLoginResponseApiResponse>> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSwitchCompany(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSwitchCompany(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<SwaggerResponse<UsuarioLoginResponseApiResponse>>;
                }
            } else
    ...
    protected processSwitchCompany(response: HttpResponseBase): Observable<SwaggerResponse<UsuarioLoginResponseApiResponse>> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class CertificadoDigitalClient {
    ...
    getValidCertificate(): Observable<SwaggerResponse<DigitalCertificateUserRelatedResponseApiResponse>> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetValidCertificate(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetValidCertificate(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<SwaggerResponse<DigitalCertificateUserRelatedResponseApiResponse>>;
                }
            } else
                return _observableThrow(response_) as any as Observable<SwaggerResponse<DigitalCertificateUserRelatedResponseApiResponse>>;
        }));
    }

    protected processGetValidCertificate(response: HttpResponseBase): Observable<SwaggerResponse<DigitalCertificateUserRelatedResponseApiResponse>> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as DigitalCertificateUserRelatedResponseApiResponse;
            return _observableOf(new SwaggerResponse(status, _headers, result200));
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<SwaggerResponse<DigitalCertificateUserRelatedResponseApiResponse>>(new SwaggerResponse(status, _headers, null as any));
    }
}
...
export class HouseClient {
    ...
    adicionarMasterHouseAssociacao(body: AddMasterHouseAssociationRequest | undefined): Observable<SwaggerResponse<MasterHouseAssociationResponseListApiResponse>> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processAdicionarMasterHouseAssociacao(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAdicionarMasterHouseAssociacao(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<SwaggerResponse<MasterHouseAssociationResponseListApiResponse>>;
                }
            } else
                return _observableThrow(response_) as any as Observable<SwaggerResponse<MasterHouseAssociationResponseListApiResponse>>;
        }));
    }

    protected processAdicionarMasterHouseAssociacao(response: HttpResponseBase): Observable<SwaggerResponse<MasterHouseAssociationResponseListApiResponse>> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as MasterHouseAssociationResponseListApiResponse;
            return _observableOf(new SwaggerResponse(status, _headers, result200));
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<SwaggerResponse<MasterHouseAssociationResponseListApiResponse>>(new SwaggerResponse(status, _headers, null as any));
    }
    ...
    atualizarMasterHouseAssociacao(body: UpdateMasterHouseAssociationRequest | undefined): Observable<SwaggerResponse<MasterHouseAssociationResponseListApiResponse>> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processAtualizarMasterHouseAssociacao(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAtualizarMasterHouseAssociacao(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<SwaggerResponse<MasterHouseAssociationResponseListApiResponse>>;
                }
            } else
    ...
    protected processAtualizarMasterHouseAssociacao(response: HttpResponseBase): Observable<SwaggerResponse<MasterHouseAssociationResponseListApiResponse>> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    desfazerMasterHouseAssociacao(body: RemoveMasterHouseAssociationRequest | undefined): Observable<SwaggerResponse<MasterHouseAssociationResponseListApiResponse>> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDesfazerMasterHouseAssociacao(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDesfazerMasterHouseAssociacao(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<SwaggerResponse<MasterHouseAssociationResponseListApiResponse>>;
                }
            } else
    ...
    protected processDesfazerMasterHouseAssociacao(response: HttpResponseBase): Observable<SwaggerResponse<MasterHouseAssociationResponseListApiResponse>> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    forUploadList(body: HouseListarRequest | undefined): Observable<SwaggerResponse<MasterHouseAssoationForUploadResponse>> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processForUploadList(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processForUploadList(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<SwaggerResponse<MasterHouseAssoationForUploadResponse>>;
                }
            } else
                return _observableThrow(response_) as any as Observable<SwaggerResponse<MasterHouseAssoationForUploadResponse>>;
        }));
    }

    protected processForUploadList(response: HttpResponseBase): Observable<SwaggerResponse<MasterHouseAssoationForUploadResponse>> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as MasterHouseAssoationForUploadResponse;
            return _observableOf(new SwaggerResponse(status, _headers, result200));
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<SwaggerResponse<MasterHouseAssoationForUploadResponse>>(new SwaggerResponse(status, _headers, null as any));
    }
}
...
export class ReceitaFederalClient {
    ...
    protected processSubmeterMasterExclusion(response: HttpResponseBase): Observable<SwaggerResponse<MasterResponseDtoApiResponse>> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    submeterHouseAgenteDeCargaPorIds(body: SubmeterRFBHouseByIdsRequest | undefined): Observable<SwaggerResponse<StringApiResponse>> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSubmeterHouseAgenteDeCargaPorIds(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSubmeterHouseAgenteDeCargaPorIds(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<SwaggerResponse<StringApiResponse>>;
                }
            } else
    ...
    protected processSubmeterHouseAgenteDeCargaPorIds(response: HttpResponseBase): Observable<SwaggerResponse<StringApiResponse>> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    submitHouseMasterAssociation(body: SubmitRFBMasterHouseRequest | undefined): Observable<SwaggerResponse<StringApiResponse>> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSubmitHouseMasterAssociation(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSubmitHouseMasterAssociation(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<SwaggerResponse<StringApiResponse>>;
                }
            } else
    ...
    protected processSubmitHouseMasterAssociation(response: HttpResponseBase): Observable<SwaggerResponse<StringApiResponse>> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    submitAssociationRemove(body: SubmitAssociatonRequest | undefined): Observable<SwaggerResponse<MasterHouseAssociationUploadResponseListApiResponse>> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSubmitAssociationRemove(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSubmitAssociationRemove(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<SwaggerResponse<MasterHouseAssociationUploadResponseListApiResponse>>;
                }
            } else
                return _observableThrow(response_) as any as Observable<SwaggerResponse<MasterHouseAssociationUploadResponseListApiResponse>>;
        }));
    }

    protected processSubmitAssociationRemove(response: HttpResponseBase): Observable<SwaggerResponse<MasterHouseAssociationUploadResponseListApiResponse>> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as MasterHouseAssociationUploadResponseListApiResponse;
            return _observableOf(new SwaggerResponse(status, _headers, result200));
            }));
        } else if (status === 404) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<SwaggerResponse<MasterHouseAssociationUploadResponseListApiResponse>>(new SwaggerResponse(status, _headers, null as any));
    }
    ...
    checkAssociationRemove(body: SubmitAssociatonRequest | undefined): Observable<SwaggerResponse<MasterHouseAssociationUploadResponseListApiResponse>> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCheckAssociationRemove(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCheckAssociationRemove(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<SwaggerResponse<MasterHouseAssociationUploadResponseListApiResponse>>;
                }
            } else
    ...
    protected processCheckAssociationRemove(response: HttpResponseBase): Observable<SwaggerResponse<MasterHouseAssociationUploadResponseListApiResponse>> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class UldClient {
    ...
    patchUldMaster(body: UldMasterPatchRequest | undefined): Observable<SwaggerResponse<UldMasterNumeroPatchQueryApiResponse>> {
        ...
        return this.http.request("patch", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processPatchUldMaster(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processPatchUldMaster(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<SwaggerResponse<UldMasterNumeroPatchQueryApiResponse>>;
                }
            } else
                return _observableThrow(response_) as any as Observable<SwaggerResponse<UldMasterNumeroPatchQueryApiResponse>>;
        }));
    }

    protected processPatchUldMaster(response: HttpResponseBase): Observable<SwaggerResponse<UldMasterNumeroPatchQueryApiResponse>> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as UldMasterNumeroPatchQueryApiResponse;
            return _observableOf(new SwaggerResponse(status, _headers, result200));
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<SwaggerResponse<UldMasterNumeroPatchQueryApiResponse>>(new SwaggerResponse(status, _headers, null as any));
    }
...
export interface AddMasterHouseAssociationRequest {
    FreightFowarderId?: number;
    Masters?: AddRFBMasterHouseItemRequest[] | undefined;
}

export interface AddRFBMasterHouseItemRequest {
    MasterNumber?: string | undefined;
    CarrierDeclarationDate?: Date | undefined;
...
export interface DigitalCertificateUserRelatedItemResponse {
    Id?: number;
    Arquivo?: string | undefined;
...
export interface DigitalCertificateUserRelatedResponse {
    Certificates?: DigitalCertificateUserRelatedItemResponse[] | undefined;
}

export interface DigitalCertificateUserRelatedResponseApiResponse {
    Sucesso?: boolean;
    Dados?: DigitalCertificateUserRelatedResponse;
    Notificacoes?: Notificacao[] | undefined;
}
...
export interface MasterHouseAssoationForUploadResponse {
    MasterAssociationItems?: MasterHouseAssociationUploadResponse[] | undefined;
    OpenMasters?: MasterHouseAssociationOpenMasterItem[] | undefined;
}
...
export interface MasterHouseAssociationOpenHouseItem {
    Id?: number;
    Number?: string | undefined;
    OriginLocation?: string | undefined;
    DestinationLocation?: string | undefined;
...
export interface MasterHouseAssociationOpenMasterItem {
    MasterNumber?: string | undefined;
    Houses?: MasterHouseAssociationOpenHouseItem[] | undefined;
}

export interface MasterHouseAssociationResponse {
    Number?: string | undefined;
    DocumentId?: string | undefined;
    CreateRFBProtocol?: string | undefined;
    CreateRFPStatus?: RFStatusEnvioType;
    CreateRFBSubmitDateTime?: Date | undefined;
    CreateRFBErrorCode?: string | undefined;
    CreateRFBErrorDescription?: string | undefined;
    CancelationRFBProtocol?: string | undefined;
    CancelationRFPStatus?: RFStatusEnvioType;
    CancelationRFBSubmitDateTime?: Date | undefined;
    CancelationRFBErrorCode?: string | undefined;
    CancelationRFBErrorDescription?: string | undefined;
    ProcessDate?: Date | undefined;
    Summary?: MasterHouseAssociationSummaryUploadResponse;
    Houses?: MasterHouseAssociationHouseItemResponse[] | undefined;
}

export interface MasterHouseAssociationResponseListApiResponse {
    Sucesso?: boolean;
    Dados?: MasterHouseAssociationResponse[] | undefined;
    Notificacoes?: Notificacao[] | undefined;
}
...
export interface MasterHouseAssociationUploadResponseListApiResponse {
    Sucesso?: boolean;
    Dados?: MasterHouseAssociationUploadResponse[] | undefined;
    Notificacoes?: Notificacao[] | undefined;
}
...
export interface RemoveMasterHouseAssociationRequest {
    FreightFowarderId?: number;
    Associations?: RemoveRFBMasterHouseItemRequest[] | undefined;
}

export interface RemoveRFBMasterHouseItemRequest {
    MessageHeaderDocumentoId?: string | undefined;
}
...
export interface SubmeterRFBHouseByIdsRequest {
    DataProcessamento?: Date;
    FreightFowarderId?: number;
    HouseIds?: number[] | undefined;
}
...
export interface SubmitAssociatonRequest {
    freightFowarderId?: number;
    associationId?: number;
}

export interface SubmitRFBMasterHouseRequest {
    FreightFowarderId?: number;
    AssociationIds?: number[] | undefined;
}
...
export interface UldMasterNumeroPatchQuery {
    ULDCaracteristicaCodigo?: string | undefined;
    ULDId?: string | undefined;
    ULDIdPrimario?: string | undefined;
    readonly ULDLinha?: string | undefined;
    ULDs?: UldMasterNumeroQueryChildren[] | undefined;
    OriginalULDCaracteristicaCodigo?: string | undefined;
    OriginalULDId?: string | undefined;
    OriginalULDIdPrimario?: string | undefined;
}

export interface UldMasterNumeroPatchQueryApiResponse {
    Sucesso?: boolean;
    Dados?: UldMasterNumeroPatchQuery;
    Notificacoes?: Notificacao[] | undefined;
}
...
export interface UldMasterPatchItemRequest {
    Id?: number | undefined;
    MasterNumero?: string | undefined;
    QuantidadePecas?: number;
    Peso?: number;
...
export interface UldMasterPatchRequest {
    TrechoId?: number;
    UldId?: string | undefined;
    UldCaracteristicaCodigo?: string | undefined;
    UldIdPrimario?: string | undefined;
    ...
    OriginalUldCaracteristicaCodigo?: string | undefined;
    OriginalUldIdPrimario?: string | undefined;
    Masters?: UldMasterPatchItemRequest[] | undefined;
}
...
export interface UpdateMasterHouseAssociationRequest {
    FreightFowarderId?: number;
    Associations?: UpdateRFBMasterHouseItemRequest[] | undefined;
}

export interface UpdateRFBMasterHouseItemRequest {
    MessageHeaderDocumentoId?: string | undefined;
    CarrierDeclarationDate?: Date | undefined;
    HouseIds?: number[] | undefined;
}
...
export interface UserSelectCompany {
    Id?: number;
...
export interface UsuarioInfoResponse {
    ...
    CertificateOwnerId?: string | undefined;
}
...
export interface UsuarioLoginResponse {
    ...
    SelectCompanies?: UserSelectCompany[] | undefined;
}
